...
public class MembersSearchableTree : ISearchableTree
{
    private readonly IEntityService _entityService;
    private readonly ISearchService _searchService;

    public MembersSearchableTree(IEntityService entityService, ISearchService searchService)
    {
        _entityService = entityService;
        _searchService = searchService;
    }

    public string TreeAlias => Constants.Trees.Members;
    ...
    public async Task<EntitySearchResults> SearchAsync(string query, int pageSize, long pageIndex, string searchFrom = null)
    {
        ...
        var searchResultEntities = entities.Select(entity => new SearchResultEntity
        {
            ...
            Udi = new GuidUdi(Constants.UdiEntityType.Member, entity.Key)
        });
