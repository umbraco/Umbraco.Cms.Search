# Handling data from others sources
...
In this article we'll explore how to index and search for bespoke data.
...
> ```
> 
> Also keep in mind that additional, field level configuraion may be needed to suit your search requirements. See the [Examine search provider](examine-provider.md) documentation for details.
...
internal sealed class BookSearchService(ISearcher searcher, IBookService bookService)
{
        ...
        int take = 10)
    {
        ...
        // sort results by title, descending
